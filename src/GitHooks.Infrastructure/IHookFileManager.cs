...
public interface IHookFileManager
{
    ...
    /// <param name="hooks">The hooks to create files for, providing both names and metadata.</param>
    ...
    public Task<HookFileCreationResult> CreateHookFilesAsync(string repositoryRootPath, string hooksPath, IReadOnlyCollection<GitHook> hooks, bool overwrite, CancellationToken cancellationToken = default);
}
